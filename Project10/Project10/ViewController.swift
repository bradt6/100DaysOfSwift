...
//  Project10
//
//  Created by Brad Thurlow on 15/3/19.
...
class ViewController: UICollectionViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let ac = UIAlertController(title: "Renamae or Delete", message: nil, preferredStyle: .alert)
        ...
        ac.addAction(UIAlertAction(title: "Delete", style: .default, handler: {(action) in
            self.deletePerson(personAtIndex: indexPath.item)
        }))
...
//        people.remove(at: indexPath.item)
    ...
    func deletePerson (personAtIndex: Int) {
        people.remove(at: personAtIndex)
        collectionView.reloadData()
    }
